...
public class CarrotAnalyzer extends Analyzer {
    public CarrotAnalyzer(Long plantId, GrowthPhase growthPhase, Map<MeasureTypeEnum, Double> values, boolean hasWater) {
        super(plantId, growthPhase, values, hasWater);
    }
